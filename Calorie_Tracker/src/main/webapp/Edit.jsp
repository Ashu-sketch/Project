...
<%@page import="java.util.ArrayList"%> 
    ...
    <%@page import="com.controller.bean.dao.UserDao"%>
    <%@page import="com.controller.bean.dao.User"%>
...
<html lang="en">
    ...
    <body>
        <div>
            ...
            <a class="btn-primary"href="<%=request.getContextPath()%>/list" class="nav-link">Users</a>
                <div class="signup-container">
                    <div class="white-card">
                        ...
                        <input type="hidden" name="id" value="<c:out value='${user.id}' />" /></div>                        
                            <div class="input-field">
                                <label>Name</label>
                                   ...
                                   <div class="input-field">
                                    ...
                                    <div class="input-field">
                                        <label>Height</label>
                                        <input type="number" step="any" min="2" max="10" placeholder="insert your height in k.g" value="<c:out value='${user.height}'/>" name ="height" required />
                                    </div>
                                    <div class="input-field">
                                        <label>Gender</label>
                                    ...
                                    <div class="input-field">
                                        ...
                                        <input type="date" placeholder="Age" name ="dob" value="<c:out value='${user.age}'/>" min='1899-01-01' max='2000-01-01' required/>
                                    </div>
